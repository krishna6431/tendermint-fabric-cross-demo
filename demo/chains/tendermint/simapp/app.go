...
import (
	...
	_ "github.com/cosmos/cosmos-sdk/client/docs/statik" // unnamed import of statik for swagger UI support
...
var (
	// Note: embedded variable must be defined by `var` instead of `const`
	ERC20Admin = "" // embedded when building
...
func NewSimApp(
	...
	app.mm.SetOrderInitGenesis(
		...
		erc20types.ModuleName, erc20mgrtypes.ModuleName, crosstypes.ModuleName, atomictypes.ModuleName,
	)
